...
<table id="game_list">
	...
	<tbody>
		...
		<?php endif; ?>
			<td><?php echo $this->Html->link('R'.$game['Game']['league_round'].' M'.$game['Game']['league_match'].' G'.$game['Game']['league_game'], array('controller' => 'Games', 'action' => 'view', $game['Game']['id'])); ?></td>
			...
			<?php if(AuthComponent::user('role') === 'admin'): ?>
				<td class="actions">
					<?php echo $this->Html->link(__('Edit'), array('controller' => 'leagues/'.$league['League']['id'], 'action' => 'editGame', $game['Game']['id'])); ?>
