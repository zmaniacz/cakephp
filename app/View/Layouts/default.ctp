					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
                                ...
                                <li><?= $this->Html->link('ECT 2017', array('controller' => 'leagues', 'action' => 'standings', '?' => array('gametype' => 'league', 'leagueID' => 17, 'centerID' => 7))); ?></li>
								<!--<li><?= $this->Html->link('Finals Bracket', array('controller' => 'pages', 'action' => 'internats2017Bracket', '?' => array('gametype' => 'league', 'leagueID' => 16, 'centerID' => 14))); ?></li>-->
